	...
	<div class="col-md-12">
		<form method="post">
			<?php 
			 $id = $_GET['id'];
               if(isset($_POST['ubah'])){
               	...
               	if($query) {
               		echo '<script>alert("Merubah data berhasil.");</script>';
               	}else{
               		echo '<script>alert("Merubah data gagal.");</script>';
               	}
               }
            ...
            <div class="row">
            	...
            	<div class="col-md-8">
			<button type="submit" class="btn btn-primary" name="ubah" value="ubah">Simpan</button>
